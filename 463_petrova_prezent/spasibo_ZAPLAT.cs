...
{
    public partial class spasibo_ZAPLAT : Form
    {
        public spasibo_ZAPLAT()
        {
            InitializeComponent();
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            label6.Text = delta.Days.ToString() + "дней,  " + delta.Hours.ToString() + "часов,  " + delta.Minutes.ToString() + "минут(и) до начала гонки";
