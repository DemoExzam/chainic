...
{
    public partial class meny_coordinator : Form
    {
        public meny_coordinator()
        {
            InitializeComponent();
        }
        ...
        {
            prosmotr_sponsoriv x = new prosmotr_sponsoriv();
            Hide();
            x.ShowDialog();
            Show();
        }
        ...
        {
            ypravlenia_begunom x = new ypravlenia_begunom();
            Hide();
            x.ShowDialog();
            Show();
        }
