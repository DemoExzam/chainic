...
{
    public partial class blagodar_begun : Form
    {
        public blagodar_begun()
        {
            InitializeComponent();
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            label4.Text = delta.Days.ToString() + "дней,  " + delta.Hours.ToString() + "часов,  " + delta.Minutes.ToString() + "минут(и) до начала гонки";
